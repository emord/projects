...
[**Prime Factorization**](https://github.com/emord/projects/blob/master/python/numbers/prime_factor.py) - Have the user enter a number and find all Prime Factors (if there are any) and display them.
...
[**Inverted index**](https://github.com/emord/projects/blob/master/python/data_structures/inverted_index.py) - An [Inverted Index](http://en.wikipedia.org/wiki/Inverted_index) is a data structure used to create full text search. Given a set of text files, implement a program to create an inverted index. Also create a user interface to do a search using that inverted index which returns a list of files that contain the query term / terms. The search index can be in memory.


Text
---------

[**Reverse a String**](https://github.com/emord/projects/blob/master/python/text/reverse.py) - Enter a string and the program will reverse it and print it out.
